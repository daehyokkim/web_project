...
<body>
	  ...
	  <fieldset>
	  	...
	  	<form method="post" name="sms" action="insertNote">
			<p>제목</p><br>
			<input type="text" name="title" placeholder="제목을 작성해 주세요." size="80" maxlength="100"><br>
			<p>내용</p>
			<textarea id="board"  name="main" rows="12" cols="52" maxlength="300" placeholder="최대 300자까지 입력 가능합니다." onkeyup="fc_chk_byte(this, 300)"></textarea><br>
			...
			<a href="note"><button type="button">취소</a>
		</form>
		</fieldset>
</body>	
	<footer id="footer">
